...
<?php 
$editpostid = mysqli_real_escape_string($conn, $_GET['editpostid']);
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
 ...
 ?>
                ...
                $getpost = db_select($query);
                if ($getpost) {
                    while ($postresult = mysqli_fetch_assoc($getpost)) {
                        ?>               
             ...
             <?php
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="hidden" name="userid" readonly value="<?php echo session_get('userId') ?>" class="medium" />
                            </td>
                        </tr>
                        <tr>
                            <td></td>
